 ...
 * 2013-01-28T12:10:51.648-05:00
 * Generated source version: 2.7.2
 * 
 */
@WebServiceClient(name = "UltraWebServiceV01Service", 
                  wsdlLocation = "https://ultra-api.ultradns.com/UltraDNS_WS/v01?wsdl",
...
public class UltraWebServiceV01Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://ultra-api.ultradns.com/UltraDNS_WS/v01?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UltraWebServiceV01Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://ultra-api.ultradns.com/UltraDNS_WS/v01?wsdl");
        }
        WSDL_LOCATION = url;
    }
